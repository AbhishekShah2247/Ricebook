...
process.env.CLOUDINARY_URL='cloudinary://613972421919886:AX5OTFmxzbEX-8ab5djc8sj1IPw@hortrcztm'

cloudinary.config({
    cloud_name: 'hortrcztm',
    api_key: '613972421919886',
    api_secret: 'AX5OTFmxzbEX-8ab5djc8sj1IPw'
});
